...
class GuestApi {
  ...
  Future<String> createSession() async {
    try {
      ...
      print('✅ Guest Session 생성 성공: $sessionId');
      return sessionId;
    } on DioException catch (e) {
      print('❌ Guest Session 생성 실패: ${e.message}');
      if (e.response != null) {
  ...
  Future<List<Question>> getQuestions() async {
    try {
      ...
      final questions = data
          ...
          .toList();
      print('✅ 질문 ${questions.length}개 조회 성공');
      return questions;
    } on DioException catch (e) {
  ...
  Future<void> submitAnswers(
    ...
    try {
      ...
      print('✅ 답변 ${answers.length}개 제출 성공');
    } on DioException catch (e) {
  ...
  Future<GuestResult> getResult(String sessionId) async {
    try {
      ...
      print('✅ 결과 조회 성공: ${result.profileType}');
      return result;
    } on DioException catch (e) {
